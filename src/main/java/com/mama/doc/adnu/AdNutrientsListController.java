...
public class AdNutrientsListController implements Execute{
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("nuList", adNutrientsDAO.selectAll(startRow, endRow, searchVO));
		request.setAttribute("cate", cate);
		request.setAttribute("keyword", keyword);
		
		
		result.setRedirect(false);
		result.setPath("/admin/adminNutrients.jsp");
