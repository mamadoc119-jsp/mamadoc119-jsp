...
<head>
    ...
    <title>상담소</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/counselingCenterModify.css">
...
<script src="${pageContext.request.contextPath}/resources/js/counselingCenterModify.js"></script>
<script>
