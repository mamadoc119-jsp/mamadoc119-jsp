...
<jsp:include page="../include/header.jsp" />   
   ...
   <!-- head //-->
   <main style="width:1515px; display:flex; flex-direction:column;">
   <div class="info" style="margin-bottom:120px; margin-right:120px; margin-left:120px;">
      <p><strong><strong>국가법령정보센터</strong></strong>는 개인정보보호법에 따라 이용자의 개인정보 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 하기 위하여 다음과 같은 처리방침을 두고 있습니다. </p>
      <p style="margin-bottom:80px;"><strong><strong>국가법령정보센터</strong></strong>는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다. </p>
      ...
      <strong>제 1장 총칙</strong>
            ...
            <p style="margin-bottom:80px;">1. 이용자 : 본 약관에 따라 당 사이트가 제공하는 서비스를 받는 자<br>
        ...
        <p>제11조 (게시물의 저작권)</p>
        <p style="margin-bottom:80px;">1. 이용자가 게시한 게시물의 저작권은 이용자가 소유하며, 당 사이트는 서비스 내에 이를 게시할 수 있는 권리를 갖습니다.<br>
        ...
        <p>제13조 (회원의 의무)</p>
        <p style="margin-bottom:80px;">1. 회원 가입시에 요구되는 정보는 정확하게 기입하여야 합니다. 또한 이미 제공된 회원에 대한 정보가 정확한 정보가 되도록 유지, 갱신하여야 하며, 회원은 자신의 계정 및 비밀번호를 제3자에게 이용하게 해서는 안됩니다.<br>
