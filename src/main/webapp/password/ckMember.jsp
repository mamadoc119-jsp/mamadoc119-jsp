    ...
    <form class="ckMember" action="${pageContext.request.contextPath}/password/changePw.jsp">
		...
		<!-- 본인 인증 양식 -->
            <div class="ckMember-email"><h5>인증 받으실 E-Mail*</h5>
                <input type="text" class="input" placeholder=" 회원가입 시 입력했던 이메일을 입력해주세요." required>
                <button class="bt-sendcode" type="button">인증코드 발송</button></div>

            <div class="ckMember-code"><h5>인증코드 입력*</h5>
                <input type="text" class="input" placeholder=" 인증코드를 입력해주세요." required>
                <button class="bt-code" type="button">인증하기</button></div>
