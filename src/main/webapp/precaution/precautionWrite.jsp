...
<head>
    ...
    <title>예방알림</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/precautionWrite.css">
...
<body>
    <div style="display: flex;margin-top: 200px;margin-bottom: 170px;justify-content: center;">
        <div style="width: 900px;display: flex;flex-direction: column;">
            ...
            <form action="${pageContext.request.contextPath}/precaution/precautionListOk.pr" method="post" onsubmit="return registMsg();">
                <!-- 제목/등록날짜 -->
...
<script src="${pageContext.request.contextPath}/resources/js/precautionWrite.js"></script>
<script>
